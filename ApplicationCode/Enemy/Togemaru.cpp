...
void Togemaru::Upda()
{
	...
	//本体
	m_Body->SetScale({ 0.050f, 0.050f, 0.050f });
...
void Togemaru::InitAnimatin()
{
	...
	for(size_t i=0;i<4;i++){
		...
		m_Model_Crush_Right[i] = Shapes::CreateSquare({ 0, 0 }, { 128.0f, 128.0f }, "togemaru_weekMoveLR.png", { 128.0f, 64.0f }, { 0.5f, 0.5f }, { 128.0f * (float)i, 0.0f }, { 128.0f, 128.0f });
		m_Model_Crush_Left[i] = Shapes::CreateSquare({ 0, 0 }, { 128.0f,128.0f }, "togemaru_weekMoveRL.png", { 128.0f, 64.0f }, { 0.5f, 0.5f }, { 128.0f * (float)i, 0.0f }, { 128.0f, 128.0f });
