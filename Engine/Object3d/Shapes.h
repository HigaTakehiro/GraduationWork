...
public: //静的メンバ関数
	...
	static Model* CreateSquare(DirectX::XMFLOAT2 upperLeft, DirectX::XMFLOAT2 lowerBottom, const std::string& textureName = "white1x1.png", const DirectX::XMFLOAT2& imageSize = { 0.0f, 0.0f }, const DirectX::XMFLOAT2& anchorpoint = { 0.5f, 0.5f }, const DirectX::XMFLOAT2& texBase = { 0.0f, 0.0f }, const DirectX::XMFLOAT2& texSize = {0.0f, 0.0f}, bool isFlip = false);
